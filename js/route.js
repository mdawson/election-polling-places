...
function ShowRoute(solveResult) {
    ...
    if (divDirections) {
        ...
        tdTotalDistance.innerHTML = "Total Distance: " + FormatDistance(directions.totalLength, "miles");
        tdTotalDistance.align = "left";

        var tdTotalTime = document.createElement("td");
        tdTotalTime.className = "tdTotalTime";
        tdTotalTime.innerHTML = "Duration: " + FormatTime(directions.totalTime);
    ...
    if (divDirections) {
        ...
        for (var i in solveResult.routeResults[0].directions.features) {
            ...
            if (i == 0) {
                ...
                if (miles) {
                    td.innerHTML = feature.attributes.text + " (" + FormatDistance(feature.attributes.length, "miles") + ")";
                }
                else {
